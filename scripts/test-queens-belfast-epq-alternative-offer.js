...
const EPQ_PATHWAY_ID = 'queens_belfast_epq_alternative';
...
assert.strictEqual(
  ...
  false,
  'QUB must use the canonical epq_alternative_offer field, not the legacy alias.'
);
...

{
  const apiResult = predict({
    universityIds: ['queen-s-belfast-a100'],
...
console.log("Queen's Belfast EPQ alternative offer activation: PASS");
