...
function contextualEvidenceOptionsForCourse(course = {}, evaluatorId = null, options = {}) {
  ...
  if (
    ...
    course.profile_id === 'king-s-college-london-a100' ||
    evaluatorId === KCL_CONTEXTUAL_EVALUATOR_ID ||
    course.profile_id === 'newcastle-a100' ||
    evaluatorId === NEWCASTLE_CONTEXTUAL_EVALUATOR_ID ||
    course.profile_id === 'brighton-and-sussex-a100' ||
    ...
    evaluatorId === CAMBRIDGE_CONTEXTUAL_EVALUATOR_ID ||
    ...
    course.profile_id === 'cardiff-a100' ||
    evaluatorId === CARDIFF_CONTEXTUAL_EVALUATOR_ID ||
    course.profile_id === 'queen-s-belfast-a100' ||
    evaluatorId === QUEEN_S_BELFAST_CONTEXTUAL_EVALUATOR_ID
  ) {
